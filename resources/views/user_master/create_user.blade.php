...
<form class="row g-5 " action="{{ route('User.store') }}" method="POST">
    @csrf
                    ...
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">                          
                                    <input type="text" class="form-control color_black" placeholder="Emter User Name" id="usr" name="name" value="{{ old('name') }}">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">                          
                                    <input type="text" class="form-control color_black" placeholder="Enter Email Address" id="usr" name="email" value="{{ old('email') }}">
