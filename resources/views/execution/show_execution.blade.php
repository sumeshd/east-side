...
<div class="tabdiv-part">
    ...
    <div class="no-tabpart">
        <ol class="list-items">
          @foreach($settings_tablists as $tablist)
            <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#home_show{{ $tablist->id}}">{{$tablist->tablist}}</a>
            </li>
          @endforeach
        </ol>
          
        <div id="btn1"> <img src="{{url('assets/images/icon/Subtraction-icon.png') }}" alt="img"></div>
    </div>      
...
<!---------------------------------------show todo----------------------------------->
        ...
        @foreach($settings_tablists as $tablist)
          <div class="tabpanel" id="home_show{{ $tablist->id}}" >
            <div id="tab_item_input" class="container tab_item_box ">
                <!-- <input type="text" id="tablist_id" name="tablist_id" value="{{ $tablist->id}}"> -->


              @foreach($settings_tasklists as $tasklist)
              @if($tablist->id == $tasklist->tablist_id )  
              <div class="tab_input">
                              
                      <h2 class="tab_heading" id="tablist" >{{ $tasklist->tasklist}}  <span id="taske_delete" class="taske_delete" ><i class="fa fa-trash"></i></span> </h2> 
                    <!-- <input type="hidden" id="tasklist" value="{{ $tasklist->tasklist}}"> -->
                 
              <div class="task" id="task_div`+ tab_number + task_number +`" >
                    <input type="hidden" id="tasklist_id" name="tasklist_id" value="{{ $tasklist->tablist_id}}">

                   
                    @foreach($settings_subtasklists as $subtasklist)
                    @if($tasklist->tasklistid == $subtasklist->tasklist_id )
                    <div class="task_content_el">
                        <form>
                          <input type="text" class="task_input_el" id="subtask_list" value="{{$subtasklist->subtasklist}}">

                          <div class="subtask-icon-sec-datashow">
                            @if($subtasklist->view == true ){
                              <a href="#" style="background:#fff !important;"> <img src="{{ url('assets/images/icon/view-svgrepo-com-true.svg') }}" alt="icon"> </a> 
                            }@else{
                              <a href="#" style="background:#fff !important;"> <img src="{{ url('assets/images/icon/view-svgrepo-com.svg') }}" alt="icon"> </a> 
                            }
                            @endif

                            @if($subtasklist->upload == true ){
                              <a href="#" style="background:#fff !important;"> <img src="{{ url('assets/images/icon/upload-svgrepo-com-true.svg') }}" alt="icon"> </a> 
                            }@else{
                              <a href="#" style="background:#fff !important;"> <img src="{{ url('assets/images/icon/upload-svgrepo-com.svg') }}" alt="icon"> </a> 
                            }
                            @endif


                            @if($subtasklist->download == true ){
                              <a href="#" style="background:#fff !important;"> <img src="{{ url('assets/images/icon/download-svgrepo-com-true.svg') }}" alt="icon"> </a> 
                            }@else{
                              <a href="#" style="background:#fff !important;"> <img src="{{ url('assets/images/icon/download-svgrepo-com.svg') }}" alt="icon"> </a> 
                            }
                            @endif



                            @if($subtasklist->comments == true ){
                              <a href="#" style="background:#fff !important;"> <img src="{{ url('assets/images/icon/comment-svgrepo-com-true.svg') }}" alt="icon"> </a> 
                            }@else{
                              <a href="#" style="background:#fff !important;"> <img src="{{ url('assets/images/icon/comment-svgrepo-com.svg') }}" alt="icon"> </a> 
                            }
                            @endif
...
window.addEventListener('load',()=>{
  ...
  //---------------------------  Task Part------------------------------------------------>
        ...
        <div class="icon3-part">
          ...
          <a onclick="myFunction()"> <img src="{{ url('assets/images/icon/chach-icon2.png') }}" alt="icon"> </a> 
          <a href="#"> <img src="{{ url('assets/images/icon/chach-icon3.png') }}" alt="icon"> </a> 
        </div>           
         ...
         //$("#task"+number).click(function(){
          ...
          // task_content_el.appendChild(task_input_el);
            ...
            <div class="subtask-icon-sec">
              <a href="#" style="background:#fff !important;"> <img src="{{ url('assets/images/icon/check-list-icon1.png') }}" alt="icon"> </a> 
              <a href="#" style="background:#fff !important;"> <img src="{{ url('assets/images/icon/check-list-icon2.png') }}" alt="icon"> </a> 
              <a href="#" style="background:#fff !important;"> <img src="{{ url('assets/images/icon/check-list-icon3.png') }}" alt="icon"> </a> 
              <a href="#" style="background:#fff !important;"> <img src="{{ url('assets/images/icon/check-list-icon4.png') }}" alt="icon"> </a> 
            </div>
