...
<div class="main-panel">
    <div class="dashboard-bodypart">
        <div class="dashboard-bodypart-in">
            <h1> Project Settings <span> <i class="fa fa-cog"></i> </span> <small>Projact Settings - Postsales </small> </h1>
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="boxthree">
                      ...
                      <ul>
                        ...
                        @endif
                        @if(!empty($postsales))
                        <li class="active"> <a href="{{ url('projectsettings/'.$postsales.'/'.$project->id) }}">Project Postsales </a> </li>
                        @endif
                        @if(!empty($execution))
                        <li> <a href="{{ url('projectsettings/'.$execution.'/'.$project->id) }}">Project Execution </a> </li>
                        @endif
                      </ul>
                    </div>
                    ...
                    <div class="progressDiv">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <hr />
                                <form action="{{ url('project/postsalesstore') }}" >
                                    @csrf
