 ...
 <div class="main-panel">
    <div class="dashboard-bodypart">
      <div class="dashboard-bodypart-in">
        <h1> Universal Settings <span> <i class="fa fa-cogs"></i> </span> <small>Universal Settings - Presales</small> </h1>
        <div class="card">
          <div class="card-body">
            ...
            <div class="boxthree">
              <ul>
                <li class="active"> <a href="{{ url('presales') }}"> Presales </a> </li>
