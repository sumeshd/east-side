      ...
      $.ajax({
        ...
        success:function(data)
        {
          if( table == "settings_presales" ){
            ...
            for( i=0 ; i <data.length ; i++ ){
              if ( data[i].view != 0) {
                view = '<a href="gallery/'+ data[i].id +'/execution" class="viewbtn3"> <img src={{ url("assets/images/icon/view-svgrepo-com.svg") }} alt="icon" style="width:17px;"></a>';         
              }
              if ( data[i].upload != 0) {
                upload = '<a href="#" class="viewbtn3"> <img src={{ url("assets/images/icon/upload-svgrepo-com.svg") }} alt="icon" style="width:17px;"></a>';         
              }
