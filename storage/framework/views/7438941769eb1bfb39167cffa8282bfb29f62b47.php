          ...
          <div class="card-body">
            ...
            <div class="boxthree">
              <ul>
                ...
                <li class="active"> <a href="<?php echo e(url('execution')); ?>"> Execution </a> </li>
              </ul>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('settings_master.index_settings', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Indranil Dhar\Desktop\Work File\East Side 16.06.2022\east-side\resources\views/settings_master/execution.blade.php ENDPATH**/ ?>