...
<form class="row g-5 " action="<?php echo e(url('/user/'.$user->id )); ?>" method="">
    <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">                          
                                    <input type="text" class="form-control color_black" placeholder="Emter User Name" id="usr" name="name" value="<?php echo e($user->name); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('customer.index_customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\php\East Side\east-side\resources\views/user_master/edit_user.blade.php ENDPATH**/ ?>