                  ...
                  <div class="col-md-7">
                    <div class="progressDiv-in">
                      ...
                      <div class="progressDiv-inbox"> <span> <img src="<?php echo e(url('assets/images/settings/psale-icon1.png')); ?>"> </span>
                        ...
                        <a href="#" class="viewbtn " id="<?php echo e($presales['id']); ?>" data-name="<?php echo e($presales['name']); ?>" data-table="project_settings" data-type="<?php echo e($presales['type']); ?>"> View check list</a> </div>
                ...
                <div class="col-md-7">
                  <div class="progressDiv-in">
                    ...
                    <div class="progressDiv-inbox"> <span> <img src="<?php echo e(url('assets/images/settings/psale-icon1.png')); ?>"> </span>
                      ...
                      <a href="#" class="viewbtn" id="<?php echo e($postsales['id']); ?>" data-name="<?php echo e($postsales['name']); ?>" data-table="project_settings" data-type="<?php echo e($postsales['type']); ?>"> View check list</a> </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-md-7">
                  <div class="progressDiv-in">
                    ...
                    <div class="progressDiv-inbox"> <span> <img src="<?php echo e(url('assets/images/settings/psale-icon1.png')); ?>"> </span>
                      ...
                      <a href="#" class="viewbtn" id="<?php echo e($execution['id']); ?>" data-name="<?php echo e($execution['name']); ?>" data-table="project_settings" data-type="<?php echo e($execution['type']); ?>"> View check list</a> </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<script type="text/javascript">
  $(document).ready(function()
  {
    ...
    //   var text = ('#logButton').innerText();;
    //   if( text == 'Show Details' ){
    //     $(".tasklog").show();
    //     ('#logButton').innerText('Hide Details');
    //   }else{
    //     $(".tasklog").hide();
    //     ('#logButton').innerText('Show Details');
    //   }
    // });
    ...
    $(document).on('click',".member", function() {
      $('.user').remove();
        ...
        $.ajax({
          url: "<?php echo e(url('/project/task')); ?>",
          type: "GET",
    ...
    $(document).on('click',".membersubmit", function() {
      ...
      //alert(user);
        $.ajax({
          url: "<?php echo e(url('/project/addmember')); ?>",
          type: "GET",
    ...
    $(document).on('click',".description", function() {
      ...
      //alert(user);
        $.ajax({
          url: "<?php echo e(url('/project/description')); ?>",
          type: "GET",
    ...
    $(document).on('click',".comment", function() {
      ...
      //alert(user);
        $.ajax({
          url: "<?php echo e(url('/project/comment')); ?>",
          type: "GET",
    ...
    $(document).on('click',".due_datesubmit", function() {
      ...
      //alert(user);
        $.ajax({
          url: "<?php echo e(url('/project/date')); ?>",
          type: "GET",
            ...
            if( data[i].field_name == 'Description'){
              var userlog = '<div class="tasklog_details">'+
                              ...
                              '<div class="row">'+
                                ...
                                '<div class="col-md-1"> '+data[i].user_name +'</div>'+
                                '<div class="col-md-11">'+
                                  '<div class="userdesc col-md-12"> '+data[i].user_name +' set this description -> '+data[i].field_data+' Jul 14 at 1:16 AM</div>'+
              ...
              var userlog = '<div class="tasklog_details">'+
                              '<div class="row">'+
                                '<div class="col-md-1"> '+data[i].user_name +'</div>'+
                                '<div class="col-md-11">'+
                                  '<div class="userdesc col-md-12"> '+data[i].user_name +' set this card to be due -> '+ moment(data[i].field_data).format('MMMM Do YYYY')+' </div>'+
                                  '<div class="user-meta col-md-12">'+ moment(data[i].created_at).format('MMMM Do YYYY')+'</div>'+
                                '</div>'+
                              '</div>'+
                            '</div>';
    ...
    function statusdate(project_settings_id){
      ...
      $.ajax({
        url: "<?php echo e(url('/task/statusdate')); ?>",
        type: "GET",
        data: { project_settings_id:project_settings_id },
        success:function(data)
        {
    ...
    $(document).on('click','.viewbtn',function(){
      ...
      //alert(stype);
      $.ajax({
        url: "<?php echo e(url('/project/parent')); ?>",
        type: "GET",
          ...
          if( stype == "presales" ){
            ...
            for( i=0 ; i <data.length ; i++ ){
              if ( data[i].can_view != 0) {
                view = '<a href="/document/'+ data[i].id +'/'+ data[i].project_id +'/'+data[i].type+'" class="viewbtn3"> <img src=<?php echo e(url("assets/images/icon/view-svgrepo-com.svg")); ?> alt="icon" style="width:17px;"></a>';         
              }
              if ( data[i].can_upload != 0) {
                upload = '<a href="/adddocument/'+ data[i].id +'/'+ data[i].project_id +'/'+data[i].type+'" class="viewbtn3"> <img src=<?php echo e(url("assets/images/icon/upload-svgrepo-com.svg")); ?> alt="icon" style="width:17px;"></a>';         
              }
              ...
              if ( data[i].can_comment != 0) {
                comments = '<a href="/comment/'+ data[i].id +'/'+ data[i].project_id +'/'+data[i].type+'" class="viewbtn3"> <img src=<?php echo e(url("assets/images/icon/comment-svgrepo-com.svg")); ?> alt="icon" style="width:17px;"></a>';         
              }
              ...
              var child  ='<div class="col-checkbox">'+
                ...
                $.ajax({ 
                  ...
                  success:function(data)
                  {
                    for( i=0 ; i <data.length ; i++ ){
                      if ( data[i].view != 0) {
                        view = '<a href="/gallery/'+ data[i].name +'/'+data[i].type+'.index" class="viewbtn3"> <img src=<?php echo e(url("assets/images/icon/view-svgrepo-com.svg")); ?> alt="icon" style="width:17px;"></a>';         
                      }
                      if ( data[i].upload != 0) {
                        upload = '<a href="/addimage/'+ data[i].name +'/'+data[i].type+'.create" class="viewbtn3"> <img src=<?php echo e(url("assets/images/icon/upload-svgrepo-com.svg")); ?> alt="icon" style="width:17px;"></a>';         
                      }
                      if ( data[i].download != 0) {
                        download = '<a href="#" class="viewbtn3"> <img src=<?php echo e(url("assets/images/icon/download-svgrepo-com.svg")); ?> alt="icon" style="width:17px;"></a>';         
                      }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('project.index_projectsettings', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Indranil Dhar\Desktop\East Side 16.06.2022\east-side\resources\views/project/project_view_settings.blade.php ENDPATH**/ ?>