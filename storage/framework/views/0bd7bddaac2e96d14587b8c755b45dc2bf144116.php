      ...
      <div class="dashboard-bodypart-in">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="boxthree">
              <ul>
                <li class="active"> <a href="<?php echo e(url('presales')); ?>"> Presales </a> </li>
                <li> <a href="<?php echo e(url('postsales')); ?>"> Postsales </a> </li>
            ...
            <div class="progressDiv">
              <div class="row">
                <div class="col-md-8">
                    ...
                    <hr />
                    <form action="<?php echo e(url('presalesstore')); ?>" >
                        <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('settings_master.index_settings', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Indranil Dhar\Desktop\Work File\East Side 16.06.2022\east-side\resources\views/settings_master/presales.blade.php ENDPATH**/ ?>