...
unset($__errorArgs, $__bag); ?></div>                                            
                                ...
                                <!-- <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div id="color_red"> <?php $__errorArgs = ['project'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><li><?php echo e($message); ?></li><?php unset($message);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('customer.index_customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Indranil Dhar\Desktop\Work File\East Side 16.06.2022\east-side\resources\views/teamwork_master/create_teamwork.blade.php ENDPATH**/ ?>