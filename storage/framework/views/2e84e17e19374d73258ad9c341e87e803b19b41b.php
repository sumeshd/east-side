                ...
                <div class="card-body">
                    ...
                    <div class="boxthree">
                      ...
                      <ul>
                        ...
                        <li> <a href="<?php echo e(url('projectsettings/'.$presales.'/'.$project->id)); ?>">Project Presales </a> </li>
                        <?php endif; ?>
                        <?php if(!empty($postsales)): ?>
                        <li class="active"> <a href="<?php echo e(url('projectsettings/'.$postsales.'/'.$project->id)); ?>">Project Postsales </a> </li>
                        <?php endif; ?>
                    ...
                    <div class="progressDiv">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <hr />
                                <form action="<?php echo e(url('project/postsalesstore')); ?>" >
                                    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('project.index_projectsettings', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Indranil Dhar\Desktop\East Side 16.06.2022\east-side\resources\views/project/project_postsales.blade.php ENDPATH**/ ?>