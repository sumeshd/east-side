...
<div class="container-scroller"> 
  ...
  <nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
      ...
      <li class="nav-item menu-items"> <a class="nav-link" href="<?php echo e(route('Execution.index')); ?>"> <span class="menu-icon"> <i class="fa fa-cog"></i> </span> <span class="menu-title">Settings</span> </a> </li>
...
</html><?php /**PATH C:\Users\Indranil Dhar\Desktop\East Side Project\LaravelStater\resources\views\execution\index_execution.blade.php ENDPATH**/ ?>