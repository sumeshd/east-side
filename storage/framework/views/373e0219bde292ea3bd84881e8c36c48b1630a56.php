  ...
  <div class="main-panel">
    <div class="dashboard-bodypart">
      <div class="dashboard-bodypart-in">
        <h1> Task <span> <i class="fa fa-tasks"></i> </span> <small>Task - View </small> </h1>
        <div class="card">
          <div class="card-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('project.index_projectsettings', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Indranil Dhar\Desktop\East Side 16.06.2022\east-side\resources\views/project/task_assingbyme.blade.php ENDPATH**/ ?>