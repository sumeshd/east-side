...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('customers', function (Blueprint $table) {
            ...
            $table->text('customer_skype_name');
            ...
            $table->text('customer_facebook_url');
            $table->text('customer_twitter_url');
            $table->text('billing_attention');
            $table->text('billing_country');
            $table->text('billing_address_street_1');
            $table->text('billing_address_street_2');
            ...
            $table->text('shipping_address_street_2');
